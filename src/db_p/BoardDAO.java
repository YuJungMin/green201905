...
public class BoardDAO {
	...
	public BoardDAO() {
		...
		try {
			DataSource ds = (DataSource)new InitialDirContext().lookup("java:comp/env/ggggg");
	...
	/*
	 * public Object list() { ArrayList<BoardDTO> res = new ArrayList<BoardDTO>();
	 * 
	 * sql = "select * from board";
	 * 
	 * try { ptmt = con.prepareStatement(sql); rs = ptmt.executeQuery();
	 * while(rs.next()) { BoardDTO dto = new BoardDTO();
	 * dto.setBid(rs.getInt("bid")); dto.setGid(rs.getInt("gid"));
	 * dto.setSeq(rs.getInt("seq")); dto.setLevel(rs.getInt("level"));
	 * dto.setNo(rs.getInt("no")); dto.setTitle(rs.getString("title"));
	 * dto.setPname(rs.getString("pname"));
	 * dto.setRegdate(rs.getTimestamp("regdate")); res.add(dto); } } catch
